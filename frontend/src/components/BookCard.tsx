...
const BookCard: React.FC<Props> = ({
  ...
  return (
    <div className="bg-white/10 border border-yellow-700/30 backdrop-blur-lg rounded-xl p-4 shadow-xl hover:shadow-yellow-500/30 transition">
      ...
      <div className="relative w-full h-48 bg-gray-800 rounded-md overflow-hidden mb-4">
        ...
        {book.cover_image ? (
          ...
          <div className="text-center text-gray-400 pt-16">Không có ảnh</div>
        )}
      </div>
