      ...
      <table className="w-full border">
        <thead>
          <tr className="bg-gray-100">
            <th className="border p-2 text-black">Ảnh</th>
            <th className="border p-2 text-black">Tên sách</th>
            <th className="border p-2 text-black">Giá</th>
            <th className="border p-2 text-black">Thao tác</th>
          </tr>
        </thead>
        ...
        <tbody>
          {books.map((b: any) => (
            <tr key={b.book_id}>
              ...
              <td className="border p-2 text-black">{b.price}</td>
